...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    contact: {
      ...
      visitUs: 'VISIT US',
      hubName: 'Muñoz & San Jose City Hub',
      hubDesc: 'Nueva Ecija, Central Luzon, Philippines',
      phoneUs: 'CALL US',
    ...
    location: {
      ...
      title: 'Service Hubs',
      subtitle:
        'Yealo serves both the Science City of Muñoz and San Jose City, Nueva Ecija with prompt daily ice routes and easy direct plant pickups.',
      distHub: 'Distribution Hub',
      distHubDesc: 'Prompt refrigerated delivery directly to your store or home',
      hoursTitle: 'Operating Hours',
      hoursValue: '6:00 AM – 8:00 PM Daily',
      hoursDesc: 'Walk-in pickup & express delivery available all week',
      viewMapBtn: 'View Map',
      callBtn: 'Call Hotline',
      routeTagTitle: 'Nueva Ecija Delivery Route',
      routeTagDesc: 'Muñoz & San Jose City Active Dispatch',
    },
    orderModal: {
    ...
    footer: {
      ...
      visitUsText: 'Muñoz & San Jose City, Nueva Ecija, Philippines',
      contactUsTitle: 'CONTACT US',
      callUsTitle: 'CALL US',
      rights: 'All rights reserved. Pure Food-Grade Ice.',
      servingNote: 'Serving Science City of Muñoz and San Jose City, Nueva Ecija.',
    },
  },
  tl: {
    nav: {
    ...
    contact: {
      ...
      hubName: 'Muñoz & San Jose City Hubs',
      hubDesc: 'Nueva Ecija, Central Luzon, Philippines',
    ...
    location: {
      ...
      title: 'Service Hubs',
      subtitle:
        'Naglilingkod ang Yealo sa Science City of Muñoz at San Jose City, Nueva Ecija via prompt daily delivery routes at direct plant pickups.',
      distHub: 'Distribution Hub',
      distHubDesc: 'Mabilis na refrigerated delivery diretso sa inyong tindahan o bahay',
      hoursTitle: 'Operating Hours',
      hoursValue: '6:00 AM – 8:00 PM Daily',
      ...
      routeTagTitle: 'Nueva Ecija Delivery Route',
      routeTagDesc: 'Active Dispatch sa Muñoz & San Jose City',
    },
    orderModal: {
      modalTitle: 'Order Yealo Ice',
      ...
      subtotal: 'Subtotal',
      deliveryFee: 'Delivery Fee',
      freeDelivery: 'FREE (Muñoz & San Jose City kapag ₱300+)',
    ...
    footer: {
      ...
      rights: 'All rights reserved. Pure Food-Grade Ice.',
      servingNote: 'Proudly serving Science City of Muñoz and San Jose City, Nueva Ecija.',
    },
  },
};
